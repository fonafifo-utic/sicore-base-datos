...
IF EXISTS (SELECT * FROM sys.objects WHERE [name] = N'MOVIMIENTO_INVENTARIO_U_TR' AND [type] = 'TR')
	DROP TRIGGER [dbo].[MOVIMIENTO_INVENTARIO_U_TR];
GO

CREATE TRIGGER [dbo].[MOVIMIENTO_INVENTARIO_U_TR]
