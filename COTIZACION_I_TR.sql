...
-- Description:	Trigger por el ingreso de una Cotización.
-- =============================================

IF EXISTS (SELECT * FROM sys.objects WHERE [name] = N'COTIZACION_I_TR' AND [type] = 'TR')
	DROP TRIGGER [dbo].[COTIZACION_I_TR];
GO

CREATE TRIGGER [dbo].[COTIZACION_I_TR]
