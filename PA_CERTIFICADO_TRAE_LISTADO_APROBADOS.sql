...
-- Description:	Trae todos los registros de la tabla Certificaciones filtrados por indicador  de estado en A.
-- =============================================

IF EXISTS(SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[PA_CERTIFICADO_TRAE_LISTADO_APROBADOS]') and objectproperty(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[PA_CERTIFICADO_TRAE_LISTADO_APROBADOS]
GO

CREATE PROCEDURE [dbo].[PA_CERTIFICADO_TRAE_LISTADO_APROBADOS]
AS
BEGIN TRY
