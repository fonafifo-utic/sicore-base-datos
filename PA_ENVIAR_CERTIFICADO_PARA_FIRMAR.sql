...
IF EXISTS(SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[PA_ENVIAR_CERTIFICADO_PARA_FIRMAR]') and objectproperty(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[PA_ENVIAR_CERTIFICADO_PARA_FIRMAR]
GO

-- =============================================
-- Author:		Álvaro Zamora Solís
-- Create date: Febrero 2025
-- Description:	Pone en cola un nuevo certificado de CO2 para ser firmado.
-- =============================================

CREATE PROCEDURE [dbo].[PA_ENVIAR_CERTIFICADO_PARA_FIRMAR] (@pFormalizacion as nvarchar(max))
AS
BEGIN TRY
	BEGIN TRAN
